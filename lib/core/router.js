...
router.get('/whoami', (req, res) => {
    if (process.env.REPL_SLUG) {
        res.end(process.env.REPL_SLUG + '.' + process.env.REPL_OWNER + '.repl.co')-i
    } if (process.env.GLITCH_SHARED_INCLUDES_LEGACY_CLS) {
        res.end(process.env.PROJECT_DOMAIN + '.' + '.glitch.me')
    } else {
